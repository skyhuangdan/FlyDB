...
const int AOF_REWRITE_PERC = 100;
const int AOF_REWRITE_MIN_SIZE = 64 * 1024 * 1024;
const bool CONFIG_DEFAULT_AOF_LOAD_TRUNCATED = true;
const bool CONFIG_DEFAULT_AOF_NO_FSYNC_ON_REWRITE = false;
